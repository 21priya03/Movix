...
<body>
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" id="food">
    <div class="w3-quarter">
     <a href="it.php"> <img src="img/it.png" alt="Sandwich" style="width:100%"></a>
      <h3>IT</h3>
      
    </div>
    <div class="w3-quarter">
     <a href="conjuring.php"> <img src="img/conjuring.jpg" alt="Steak" style="width:100%"></a>
      <h3>The Conjuring</h3>
    </div>  
    ...
    <div class="w3-quarter">
      <a href="kingkong.php"><img src="img/kk.jpg" alt="Sandwich" style="width:100%"></a>
      <h3>King Kong</h3>
