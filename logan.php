            ...
            <div class="container">
                <div class="page">
                    <div class="breadcrumbs">
                        ...
                        <hr>
                        <div class="heading">
                       <h1>Logan<span><h4>(2017)</h4></span></h1>
                        <h3>R | 2h 17min | Action, Drama, Sci-Fi | 3 March 2017 (USA)   </h3>
                    ...
                    <div class="row1">
                        <div class="column1" /*style="background-color:#aaa;"*/>
                          <img src="img/logan.jpg" alt="coco poster">
                        </div>
                    ...
                    <div class="story">
                        <h1>Storyline</h1>
                        <p style="color:black;">
                            In a future where mutants are nearly extinct, an elderly and weary Logan leads a quiet life. But when Laura, a mutant child pursued by scientists, comes to him for help, he must get her to safety <br/>
                           <br/>
                           
                           
                           
                           
                            <b>Directors</b>:  James Mangold <br/>
                            <b>Writers</b>: James Mangold (story by), Scott Frank (screenplay by) | 2 more credits » <br/>
                            <b>Stars</b>: Hugh Jackman, Patrick Stewart, Dafne Keen | See full cast & crew » 
                        </p>
                        ...
                        <p>
							...
							<br>
							Also Known As: Logan See more »
							<br>
							Filming Locations: Just outside Northern Meadows community, Rio Rancho, New Mexico, USA See more » 
							<br>
                        </p>
                    </div>
                    ...
                    <div class="review">
                           <h1> User Reviews</h1>
                            <p>
                            <h3>If there was ever a comic book movie deemed worthy of perfect, Logan is it.</h3>
								23 February 2017 | by trublu215
